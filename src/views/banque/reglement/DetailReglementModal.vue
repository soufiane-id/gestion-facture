<template>
  <div>
    ...
    >
      <h5>
        <strong style="text-decoration: underline;">Factures correspondantes à cette opération :</strong>
      </h5>
      <b-table
        small
        :fields="fields"
      ...
      >
        <template v-slot:cell(moyenPaiement)="echeanciers">
          <b-badge
            :variant="getBadge(echeanciers.item.moyenPaiement)"
          >{{echeanciers.item.moyenPaiement}}</b-badge>
        </template>
