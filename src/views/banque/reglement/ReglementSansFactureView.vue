<template>
    <div>
      <!-- <ReglementVirementModule :operation='operationARegler' /> -->
      <b-table
        id="my-table"
...
export default {
  ...
  methods: {
      afficherReglementsSansFacture(){
      http
        .get("/operationsAttenteFacture")
        .then(response => {
    ...
    getBadge (status) {
      return status === 'TRANSFERE' ? 'success' : 'danger'
    },
     /**  
