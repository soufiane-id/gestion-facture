<template>
  <div class="msl-searchable-list">
    ...
    <div class="msl-searchable-list__items">
      ...
      >{{ getOptionDisplay(option, displayProperty) }}</div>

      <div v-if="noItems" class="msl-searchable-list__no-item">{{ noOptionsText }}</div>

      <div v-if="noFilteredItems" class="msl-searchable-list__no-item">{{ noItemsFoundText }}</div>
    </div>
  </div>
</template>
